...
```sh
[root@ec2-34-235-121-19 /]# ls /opt 
/opt
[root@ec2-34-235-121-19 /]# ls /var/log/
anaconda  btmp             cloud-init.log  dmesg      grubby_prune_debug  maillog           messages-20171126  rhsm             spooler           tuned
audit     choose_repo.log  cron            dmesg.old  lastlog             maillog-20171126  ntpstats           secure           spooler-20171126  wtmp
boot.log  chrony           cron-20171126   grubby     log                 messages          qemu-ga            secure-20171126  tallylog          yum.log
[root@ec2-34-235-121-19 /]# mkdir -p /data/disk0/opt
[root@ec2-34-235-121-19 /]# cp -R /var/log /data/disk1/log
[root@ec2-34-235-121-19 /]# ln -s -f /data/disk0/opt /opt
[root@ec2-34-235-121-19 /]# ln -s -f /data/disk1/log /var/log
[root@ec2-34-235-121-19 /]# mv /var/log /var/log.bak
[root@ec2-34-235-121-19 /]# mv /opt /opt.bak
[root@ec2-34-235-121-19 /]# ls -a /data/disk0/opt /data/disk1/log
/data/disk0/opt:
.  ..  opt
